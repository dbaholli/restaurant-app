...
GO
INSERT [dbo].[Customers] ([CustomerId], [CustomerName]) VALUES (1, N'Diell Baholli')
GO
INSERT [dbo].[Customers] ([CustomerId], [CustomerName]) VALUES (2, N'Altina Ibrahimi')
GO
INSERT [dbo].[Customers] ([CustomerId], [CustomerName]) VALUES (3, N'Fortesa Reqica')
GO
INSERT [dbo].[Customers] ([CustomerId], [CustomerName]) VALUES (4, N'Edon Ibrahimaj')
GO
INSERT [dbo].[Customers] ([CustomerId], [CustomerName]) VALUES (5, N'Leonora Mavriqi')
GO
...
GO
INSERT [dbo].[FoodItems] ([FoodItemId], [FoodItemName], [Price]) VALUES (15, N'Pepperoni Pizza', CAST(5.99 AS Decimal(18, 2)))
GO
INSERT [dbo].[FoodItems] ([FoodItemId], [FoodItemName], [Price]) VALUES (16, N'Margherita Pizza', CAST(4.99 AS Decimal(18, 2)))
GO
INSERT [dbo].[FoodItems] ([FoodItemId], [FoodItemName], [Price]) VALUES (17, N'PedroTech Special Pizza', CAST(6.53 AS Decimal(18, 2)))
GO
INSERT [dbo].[FoodItems] ([FoodItemId], [FoodItemName], [Price]) VALUES (18, N'Vegan Pizza', CAST(4.99 AS Decimal(18, 2)))
GO
INSERT [dbo].[FoodItems] ([FoodItemId], [FoodItemName], [Price]) VALUES (18, N'Pineapple Pizza', CAST(3.99 AS Decimal(18, 2)))
GO
